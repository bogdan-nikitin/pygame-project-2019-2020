...
[data/tile_config.json](#о-файле-tile_configjson). На конце каждого уровня стоит 
...
[data/levels.json](#о-файле-leveljson).
...
[соответствующем разделе](#редактор-уровней---leveleditorpy). При запуске команд, связанных с 
...
том же [разделе](#редактор-уровней---leveleditorpy), что и команды редактора. Для выхода из 
